...
def load_data():
    ...
    mrr["churn_rate_pct"] = (
        ...
        (mrr["active_subscribers"] + mrr["churned_subscribers"]).replace(0, np.nan) * 100
    ).round(2)
    ...
    rfm = subs[[
        "subscriber_id","lifetime_revenue_usd","churned","plan","region","nps_score",
        "tenure_months","monthly_price_usd","churned_bool","nps_category",
